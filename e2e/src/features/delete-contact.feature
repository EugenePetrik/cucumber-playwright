Feature: As a user I expect to be able to delete a new contact
  ...
  Scenario: As a user I can delete a new contact
    ...
    When I fill in the "search" input with "Maude Flanders"
  ...
  Scenario: As a user I can create delete the second searched contact
    ...
    When I click the "create" button
    Then I am directed to the "create contact" page
    When I fill in the "name" input with "Selma Bouvier"
    And I select the "Female" option from the "gender"
    ...
    When I fill in the "search" input with "Patricia Bouvier"
    Then the "contact" should be displayed
    And the "full name label" should contain the text "Name:"
    ...
    When I fill in the "search" input with "Selma Bouvier"
    Then the "contact" should be displayed
    And the "full name label" should contain the text "Name:"
    ...
    When I fill in the "search" input with "Bouvier"
    Then the "1st" "contact" should be displayed
